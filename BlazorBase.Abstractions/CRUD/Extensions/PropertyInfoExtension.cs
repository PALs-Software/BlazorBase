...
public static class PropertyInfoExtension
{
    ...
    {
        return propertyInfo.HasAttribute(typeof(UseCustomLookupDataAttribute));
    }
    ...
    public static bool IsVisibleInGUI(this PropertyInfo propertyInfo, GUIType? guiType = null, List<string>? userRoles = null)
    {
        ...
        if (isVisible && propertyInfo.IsBaseModelDateProperty())
            return !propertyInfo.HideBaseModelDateProperties(guiType);
        else
            return isVisible;
    }
