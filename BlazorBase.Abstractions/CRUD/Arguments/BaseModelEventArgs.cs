...
public record OnGetPropertyCaptionArgs(IBaseModel Model, IDisplayItem DisplayItem, EventServices EventServices)
{
    public OnGetPropertyCaptionArgs(IBaseModel model, IDisplayItem displayItem, string caption, EventServices eventServices) : this(model, displayItem, eventServices) => Caption = caption;
...
public record OnAfterSetUpDisplayListsArgs(Type ModelType, GUIType GuiType, IBaseModel? ComponentModelInstance, Dictionary<PropertyInfo, IDisplayItem> VisiblePropertyDictionary, Dictionary<string, IDisplayGroup> DisplayGroups, List<string> UserRoles);
...
public record OnShowEntryArgs(GUIType GuiType, IBaseModel Model, bool AddingMode, bool ViewMode, Dictionary<PropertyInfo, IDisplayItem> VisiblePropertyDictionary, Dictionary<string, IDisplayGroup> DisplayGroups, EventServices EventServices);
#endregion
