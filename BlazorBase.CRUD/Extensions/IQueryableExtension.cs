...
{
    static readonly MethodInfo LikeMethodInfo = typeof(DbFunctionsExtensions).GetMethod("Like", [typeof(DbFunctions), typeof(string), typeof(string)])!;
    static readonly MethodInfo StringContainsMethodInfo = typeof(string).GetMethod("Contains", [typeof(string), typeof(StringComparison)])!;
    static readonly MethodInfo ToStringMethodInfo = typeof(object).GetMethod("ToString")!;
    static readonly Expression EFFunctionsConstant = Expression.Constant(EF.Functions);
    static readonly Expression EmptyStringConstant = Expression.Constant(String.Empty);
    static readonly Expression NullConstant = Expression.Constant(null);
    static readonly Expression EmptyGuid = Expression.Constant(Guid.Empty, typeof(Guid));
    static readonly Expression EmptyNullableGuid = Expression.Constant(Guid.Empty, typeof(Guid?));
